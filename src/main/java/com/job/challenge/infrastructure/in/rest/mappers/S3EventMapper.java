...
public class S3EventMapper {
    ...
    public static S3Event toS3Event(S3EventDto event) {
    ...
    public static S3EventDto toS3EventDto(S3Event event) {
    ...
    public static Mono<S3EventDto> toS3EventDto(Mono<S3Event> event) {
